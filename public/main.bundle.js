...
module.exports = "body.form-color {\n  color: #2a89e2;\n  background-color: #e69b84;\n  height: 100%;\n  width: 100%;\n  margin: 0;\n  padding: 0; }\n\ninput.scaleInput[type=\"text\"] {\n  width: 300px; }\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.colorEntireDom = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__keys_service__ = __webpack_require__("./src/app/keys.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__key_pick_key_pick_component__ = __webpack_require__("./src/app/key-pick/key-pick.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__key_certainty_drill_key_certainty_drill_component__ = __webpack_require__("./src/app/key-certainty-drill/key-certainty-drill.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_12__key_pick_key_pick_component__["a" /* KeyPickComponent */],
                __WEBPACK_IMPORTED_MODULE_13__key_certainty_drill_key_certainty_drill_component__["a" /* KeyCertaintyDrillComponent */],
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_8__keys_service__["a" /* KeysService */]],
    ...
    KeyCertaintyDrillComponent.prototype.getKeyClass = function (typeKey) {
        ...
        this.keysService.getAllKeys(typeKey)
            ...
            if (test == isRightKey) {
                ...
                var audioPlayer2 = document.getElementById('wrongSound');
                audioPlayer2.play()
                    .then(function () {
...
module.exports = " <!-- <app-menu></app-menu> -->\n\n<form class=\"form-color\" [formGroup]=\"form\">\n  <div style=\"text-align:center\">\n      <h1>\n          Welcome to {{ title }}!<br><br>\n        </h1>   \n        <h3>Click the checkboxes for each key you wish to drill. Once you have picked your keys, hit the submit\n          button and the program will randomly pick a key to start with. Once your key is displayed, type in the spelling for that key using all capital letters, the # symbol for sharps, and the lowercase 'b' for the flat symbol. Leave a space between each note. Please note, the answer will be wrong if you don't have a space between each note and use caps. \n        </h3><br><br>\n    <div>\n      <label formArrayName=\"keyNames\" *ngFor=\"let keyName of form.controls.keyNames.controls; let i = index\">\n        <input type=\"checkbox\" [formControlName]=\"i\">\n        <h5 [style.margin-left]=\"'20px'\">{{ keyNames[i].name }}</h5>\n      </label>\n    </div>\n    <div>\n        <h4>Keys to Drill: {{ keysToDrill() }}</h4>\n      <button   class=\"btn btn-primary\" (click)=\"submit()\">Get a Random Key</button>      \n      <h3>Key to Drill:</h3><h3 id=\"drillKey\"></h3>\n    </div>\n  </div>\n</form>\n"
