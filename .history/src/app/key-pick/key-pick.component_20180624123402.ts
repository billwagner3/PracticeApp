...
export class KeyPickComponent implements OnInit {
  ...
  keyNames = [
    { name: 'C Major'}, { name: 'G Major'}, { name: 'D Major'},
    { name: 'A Major'}, { name: 'E Major'}, { name: 'B Major'},
    { name: 'F# Major'}, { name: 'C# Major'}, { name: 'F Major'},
    { name: 'Bb Major'}, { name: 'Eb Major'}, { name: 'Ab Major'},
    { name: 'Db Major'}, { name: 'Gb Major'}, { name: 'Cb Major'},
    { name: 'A Minor'}, { name: 'E Minor'}, { name: 'B Minor'},
    { name: 'F# Minor'}, { name: 'C# Minor'}, { name: 'G# Minor'},
    { name: 'D# Minor'}, { name: 'A# Minor'}, { name: 'D Minor'},
    { name: 'G Minor'}, { name: 'C Minor'}, { name: 'F Minor'},
    { name: 'Bb Minor'}, { name: 'Eb Minor'}, { name: 'Ab Minor'}
  ]
