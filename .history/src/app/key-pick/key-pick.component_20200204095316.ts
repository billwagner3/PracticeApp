import { Component, OnInit, NgZone, Injectable, Pipe, PipeTransform, ChangeDetectionStrategy, ChangeDetectorRef } from '@angular/core';
...
export class KeyPickComponent implements OnInit, OnDestroy {
  ...
  constructor(private keysService: KeysService, private fb: FormBuilder, private router: Router, private cdr: ChangeDetectorRef) {
