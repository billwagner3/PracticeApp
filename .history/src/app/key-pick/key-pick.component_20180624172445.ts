...
export class KeyPickComponent implements OnInit {
  ...
  constructor(private keysService: KeysService, private fb: FormBuilder, router: Router) {
  ...
  submit() {
    ...
    return this.router.navigate(['../key-certainty-drill/key-certainty-drill.component.html'])
  }
