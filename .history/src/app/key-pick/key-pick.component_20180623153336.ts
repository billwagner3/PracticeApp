...
export class KeyPickComponent implements OnInit {
  ...
  keyNames: [
    { name: 'C', selected: false}, { name: 'G', selected: ''}, { name: 'D', selected: ''},
    { name: 'A', selected: ''}, { name: 'E', selected: ''}, { name: 'B', selected: ''},
    { name: 'F#', selected: ''}, { name: 'C#', selected: ''}, { name: 'F', selected: ''},
    { name: 'Bb', selected: ''}, { name: 'Eb', selected: ''}, { name: 'Ab', selected: ''},
    { name: 'Db', selected: ''}, { name: 'Gb', selected: ''}, { name: 'Cb', selected: ''},
    { name: 'a', selected: ''}, { name: 'e', selected: ''}, { name: 'b', selected: ''},
    { name: 'f#', selected: ''}, { name: 'c#', selected: ''}, { name: 'g#', selected: ''},
    { name: 'd#', selected: ''}, { name: 'a#', selected: ''}, { name: 'd', selected: ''},
    { name: 'g', selected: ''}, { name: 'c', selected: ''}, { name: 'f', selected: ''},
    { name: 'bb', selected: ''}, { name: 'eb', selected: ''}, { name: 'ab', selected: ''}
  ]
  ...
  constructor(private keysService: KeysService, private fb: FormBuilder) {
   ...
   buildKeyNames() {
     const arr = this.keyNames.map(keyName => {
      return this.fb.control(this.keyNames.selected);
     })
   }
